// Script creating a modal when the featured movie’s button or movie image is clicked.
...
function createModal(movieId) {
    ...
    let close_modal = document.getElementsByClassName("close-modal-btn")[0];
    modal.style.display = "block";

    fetch(titlesEntryUrl + movieId)
